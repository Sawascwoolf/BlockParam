...
// public `ICommand` properties on MultiSelectInternalState and bound via
...
public sealed class MultiSelectRelayCommand : ICommand
{
    private readonly Action<object?> _execute;
    private readonly Func<object?, bool>? _canExecute;

    public MultiSelectRelayCommand(Action<object?> execute, Func<object?, bool>? canExecute = null)
    {
        _execute = execute;
        _canExecute = canExecute;
    }

    public MultiSelectRelayCommand(Action execute, Func<bool>? canExecute = null)
